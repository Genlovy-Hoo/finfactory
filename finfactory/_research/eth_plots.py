...
if __name__ == '__main__':
    ...
    #%%
    data = load_daily_crypto_usdt('eth', 'eth_usdt')
    ...
    plot_candle(data_, args_ma=None, args_boll=[20, 2],
                ...
                plot_below=None,
                figsize=(11, 9))
    data_ = data[(data['time'] >= '2020-05-01') & \
                  (data['time'] <= '2021-01-31')]
    plot_candle(data_, args_ma=None, args_boll=[20, 2],
                # plot_below='vol',
                plot_below=None,
                figsize=(11, 9))
    data_ = data[(data['time'] >= '2017-03-01') & \
                  (data['time'] <= '2018-02-29')]
    plot_candle(data_, args_ma=None, args_boll=[20, 2],
                # plot_below='vol',
                plot_below=None,
                figsize=(11, 9))
    data_ = data[(data['time'] >= '2017-01-01') & \
                  (data['time'] <= '2017-07-31')]
    plot_candle(data_, args_ma=None, args_boll=[20, 2],
                # plot_below='vol',
                plot_below=None,
                figsize=(11, 9))
