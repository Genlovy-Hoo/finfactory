...
def get_bond_yields_by_date(date, save_ori=False,
    ...
    def _save_ori():
        ...
        if isnull(ori_save_path):
            save_dir = find_target_dir('chn_national_bond_rates/data_ori/',
...
if __name__ == '__main__':
    ...
    logger = simple_logger('../../log/get_data_chn_national_bond_rates.log', 'a')
