...
def _check_loss(data, symbol, minute, logger=None):
    '''检查缺失'''
...
def update_minute_by_exist(symbol, minute, df_exist=None,
...
def update_daily(symbol, minute,
    ...
    data_all =  update_minute_by_exist(symbol,
                                       minute,
                                       df_exist=None,
                                       fpath=save_path,
    ...
    _ = _check_loss(data_all, symbol, minute, logger)
...
if __name__ == '__main__':
    ...
    for minute in minutes:
        for symbol, name1, name2, mkt, start_time in symbols:
            exec('''df_{} = try_update_daily(symbol,
                                             minute,
                                             save_path=None,
                                             root_dir=None,
